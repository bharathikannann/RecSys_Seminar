...
```{python}
# df_train.to_csv('dataset/New folder/train.csv', index = False, header=True)
# df_test.to_csv('dataset/New folder/test.csv', index = False, header=True)
```

```{python}
# temp = pd.read_csv('dataset/New folder/train.csv')
# temp.head()
```
